...
public class Main {
    ...
    public static void prospectToCustomerMenu(Scanner scanner) {
        ...
        try {
            Integer addNasabah = Integer.parseInt(scanner.nextLine());
...
//                TODO: ADD DETAIL POLICY
    ...
    public static void buyProductMenu(Scanner scanner) {
        ...
        Nasabah nasabah = Asuransi.findNasabahByNomor(nomorCustomer);
        if (nasabah != null) {
            nasabah.printDataNasabah();
        } else {
...
//        inputDataTertanggung(scanner, polis);
        ...
        Boolean hasil = Asuransi.addDataPolisNasabah(nasabah, polis);
        if (!hasil) {
    ...
    //input data yang akan ditanggung
    public static Polis inputDataTertanggung(Scanner scanner, Polis polis) {
        ...
        Nasabah nasabah = Asuransi.findNasabahByNomor(nomorCustomerTertanggung);
        if (nasabah == null) {
            System.out.println("Nasabah tertanggung tidak ditemukan");
            buyProductMenu(scanner);
        }
    ...
    public static void detailPolicyMenu(Scanner scanner) {
        ...
        nasabah.printAllDataCustomerPolicy();

        //TODO Add data customer?
